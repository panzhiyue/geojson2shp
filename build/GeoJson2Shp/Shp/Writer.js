 ...
 * 
 */
var Writer = function Writer(geometries, type) {
    /**
     * 图形数组
 ...
 */
Writer.prototype.write = function write (callback) {
 ...
 */
Writer.prototype.writeHeader = function writeHeader (view) {
 ...
 * @param {DataView} view 视图
 */
Writer.prototype.writeExtent = function writeExtent (extent, view) {
 ...
 * @param {any} shxView
 */
Writer.prototype.writeGeometry = function writeGeometry (shpView, shxView) {
 ...
 */
Writer.prototype.getShpLength = function getShpLength () {
 ...
 */
Writer.prototype.getShxLength = function getShxLength () {
 ...
 */
Writer.prototype.getExtent = function getExtent () {
 ...
 * @return {number} 子图形数量
 */
Writer.prototype.getPartCount = function getPartCount (geometries) {
};
 ...
 */
Writer.prototype.getFlattened = function getFlattened (coords, l) {
    if (l === undefined) { l = []; }
