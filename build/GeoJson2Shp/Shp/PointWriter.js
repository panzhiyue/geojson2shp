 ...
 *          |-----------------------|  v
 */
var PointWriter = /*@__PURE__*/(function (Writer) {
    function PointWriter(geometries, type) {
        Writer.call(this, geometries, type);
    }

    if ( Writer ) PointWriter.__proto__ = Writer;
    PointWriter.prototype = Object.create( Writer && Writer.prototype );
    PointWriter.prototype.constructor = PointWriter;

    /**
     * @inheritdoc
     */
    PointWriter.prototype.writeGeometry = function writeGeometry (shpView, shxView) {
     ...
     * @inheritdoc 
     */
    PointWriter.prototype.getPartCount = function getPartCount (geometries) {
     ...
     * @inheritdoc
     */
    PointWriter.prototype.getExtent = function getExtent () {
     ...
     * @inheritdoc
     */
    PointWriter.prototype.getShpLength = function getShpLength () {
     ...
     * @inheritdoc
     */
    PointWriter.prototype.getShxLength = function getShxLength () {
...
//# sourceMappingURL=PointWriter.js.map