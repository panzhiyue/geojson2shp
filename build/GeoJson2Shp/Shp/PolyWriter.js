 ...
 * ----------------------------------------
 */
var PolyWriter = /*@__PURE__*/(function (Writer) {
    function PolyWriter(geometries, type) {
        Writer.call(this, geometries, type);
    }

    if ( Writer ) PolyWriter.__proto__ = Writer;
    PolyWriter.prototype = Object.create( Writer && Writer.prototype );
    PolyWriter.prototype.constructor = PolyWriter;

    /**
     * @inheritdoc
     */
    PolyWriter.prototype.writeGeometry = function writeGeometry (shpView, shxView) {
     ...
     * @inheritdoc 
     */
    PolyWriter.prototype.getPartCount = function getPartCount (geometries) {
        var no = 1;
     ...
     * @inheritdoc
     */
    PolyWriter.prototype.getExtent = function getExtent () {
     ...
     * @inheritdoc
     */
    PolyWriter.prototype.getShpLength = function getShpLength () {
     ...
     * @inheritdoc
     */
    PolyWriter.prototype.getShxLength = function getShxLength () {
...
//# sourceMappingURL=PolyWriter.js.map