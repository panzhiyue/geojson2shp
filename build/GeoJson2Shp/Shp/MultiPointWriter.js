 ...
 * ----------------------------------------
 */
var MultiPointWriter = /*@__PURE__*/(function (Writer) {
    function MultiPointWriter(geometries, type) {
        Writer.call(this, geometries, type);
    }

    if ( Writer ) MultiPointWriter.__proto__ = Writer;
    MultiPointWriter.prototype = Object.create( Writer && Writer.prototype );
    MultiPointWriter.prototype.constructor = MultiPointWriter;

    /**
     * @inheritdoc
     */
    MultiPointWriter.prototype.writeGeometry = function writeGeometry (shpView, shxView) {
     ...
     * @inheritdoc
     */
    MultiPointWriter.prototype.getPartCount = function getPartCount (geometries) {
     ...
     * @inheritdoc
     */
    MultiPointWriter.prototype.getExtent = function getExtent () {
     ...
     * @inheritdoc 
     */
    MultiPointWriter.prototype.getShxLength = function getShxLength () {
     ...
     * @inheritdoc 
     */
    MultiPointWriter.prototype.getShpLength = function getShpLength () {
...
//# sourceMappingURL=MultiPointWriter.js.map