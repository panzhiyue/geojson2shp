 ...
 * 
 */
var Writer = function Writer(data, field_meta) {
...
Writer.prototype.write = function write (callback) {
    ...
    this.field_meta_.forEach(function (f, i) {
        //字段名称占10位
        var name = f.name.slice(0, 10);
        name = Lib.rpad(name, 10, " ");
        var uint8Array = Lib.stringToUint8Array(name);
 ...
 */
Writer.prototype.writeField_ = function writeField_ (view, fieldLength, str, offset) {
    var uint8Array = Lib.stringToUint8Array(str);
 ...
 */
Writer.prototype.getBytesPerRecord = function getBytesPerRecord (fields) {
    // deleted flag
